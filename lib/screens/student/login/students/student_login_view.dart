...
class StudentLoginView extends StatefulWidget {
  static Route route() => MaterialPageRoute(builder: (context) => StudentLoginView());

  @override
  State<StudentLoginView> createState() => StudentLoginViewState();
}

class StudentLoginViewState extends State<StudentLoginView> {
